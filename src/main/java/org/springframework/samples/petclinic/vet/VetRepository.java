...
public interface VetRepository extends Repository<Vet, Integer> {
	...
	List<Vet> findByFirstNameAndLastName(@Param("firstName") String firstName, @Param("lastName") String lastName);

	@Query("SELECT vet FROM Vet vet WHERE vet.firstName =:firstName or vet.lastName=:lastName")
	List<Vet> findByFirstNameOrLastName(@Param("firstName") String firstName, @Param("lastName") String lastName);
